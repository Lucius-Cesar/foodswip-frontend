  ...
  return (
    <div className="w-screen h-screen flex flex-col justify-between items-center p-2">
      <div className="w-screen h-screen flex flex-col items-center">
        <RestaurantLogo />
        <div className="flex flex-col justify-center items-center space-y-2 mt-6  p-2">
          ...
          <p className="text-xl sm:text-base text-center">
            ...
            validée.<br></br> <br></br>Vous recevrez un mail de confirmation
            dans les prochaines minutes, contenant les informations sur les
            délais de livraison ou de retrait.
          </p>
        </div>
      </div>
