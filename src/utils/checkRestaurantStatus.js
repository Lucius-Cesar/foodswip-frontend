      ...
      if (schedule[currentDayOfWeek].services.length === 0) {
        ...
        for (let i = 0; i < servicesOfCurrentDay.length; i++) {
          ...
          if (
            ...
            remainingServicesForCurrentDay = schedule[
              currentDayOfWeek
            ...
            remainingServicesForCurrentDay.push(servicesOfCurrentDay[i]);
          ...
          restaurantOpen = remainingServicesForCurrentDay.length ? true : false;
        }
      }
    }
